...
return {
    ...
    ['Helpers']       = {
        ...
        ShouldUseDireCharm = function()
            -- Use only the shared charm module settings.
            return Config:GetSetting('CharmOn', true) and Config:GetSetting('DireCharm', true)
        end,
        DireCharmTargetLevel = function()
            return Config:GetSetting('DireCharmMaxLvl', true) or 46
        end,
    },
    ['RotationOrder'] = {
        ...
        },
        {
            ...
            targetId = function(self) return Targeting.CheckForAutoTargetID() end,
            cond = function(self, combat_state)
                return self.Helpers.ShouldUseDireCharm() and combat_state == "Combat" and Targeting.AggroCheckOkay()
            end,
        },
        {
            name = 'DPS(100+)',
        ...
        },
        {
            ...
            steps = 1,
            load_cond = function()
                return Config:GetSetting('DoFireDPS') and
        ...
        },
        {
            ...
            steps = 1,
            load_cond = function()
                return Config:GetSetting('DoIceDPS') and
                    (mq.TLO.Me.Level() < 71 or (not Core.GetResolvedActionMapItem('ChaosNuke') and not Core.GetResolvedActionMapItem('WildNuke')))
            end,
            doFullRotation = true,
            targetId = function(self) return Targeting.CheckForAutoTargetID() end,
        ...
        },
        {
            ...
            steps = 1,
            load_cond = function()
                return Config:GetSetting('DoMagicDPS') and
                    (mq.TLO.Me.Level() < 71 or (not Core.GetResolvedActionMapItem('ChaosNuke') and not Core.GetResolvedActionMapItem('WildNuke')))
            end,
            doFullRotation = true,
            targetId = function(self) return Targeting.CheckForAutoTargetID() end,
        ...
        ['Dire Charm'] = {
            {
                ...
                cond = function(self, aaName, target)
                    ...
                    return Casting.CanUseAA(aaName) and
                        self.Helpers.ShouldUseDireCharm() and
                        mq.TLO.Me.Pet.ID() == 0 and
                        targetLevel == self.Helpers.DireCharmTargetLevel()
                end,
            },
            {
                name = "Dire Charm",
    ...
    ['Spells']        = {
        {
            ...
            spells = {
                ...
                --1-70
                { name = "FireNuke",   cond = function() return Config:GetSetting('DoFireDPS') end, },
                { name = "IceNuke",    cond = function() return Config:GetSetting('DoIceDPS') end, },
                { name = "MagicNuke",  cond = function() return Config:GetSetting('DoMagicDPS') end, },
        ...
        },
        {
            ...
            spells = {
                ...
                --1-70
                { name = "BigFireNuke",      cond = function() return Config:GetSetting('DoFireDPS') end, },
                { name = "BigIceNuke",       cond = function() return Config:GetSetting('DoIceDPS') end, },
                { name = "BigMagicNuke",     cond = function() return Config:GetSetting('DoMagicDPS') end, },
            },
        },
        {
            gem = 3,
        ...
        },
        {
            ...
            spells = {
                ...
                { name = "FireRain",  cond = function() return Config:GetSetting('DoRain') and Config:GetSetting('DoFireDPS') end, },
                { name = "IceRain",   cond = function() return Config:GetSetting('DoRain') and Config:GetSetting('DoIceDPS') end, },
                { name = "EvacSpell", },
    ...
    ['DefaultConfig'] = {
        ...
        -- Low Level
        ['DoFireDPS']            = {
            DisplayName = "Use Fire DPS",
            Group = "Abilities",
            Header = "Damage",
            Category = "Direct",
            Index = 101,
            Tooltip = "Use fire-based low-level DPS (1-70) rotations and spell gems.",
            Default = true,
            RequiresLoadoutChange = true,
        },
        ['DoIceDPS']             = {
            DisplayName = "Use Ice DPS",
            Group = "Abilities",
            Header = "Damage",
            Category = "Direct",
            Index = 102,
            Tooltip = "Use ice-based low-level DPS (1-70) rotations and spell gems.",
            Default = false,
            RequiresLoadoutChange = true,
        },
        ['DoMagicDPS']           = {
            DisplayName = "Use Magic DPS",
            Group = "Abilities",
            Header = "Damage",
            Category = "Direct",
            Index = 103,
            Tooltip = "Use magic-based low-level DPS (1-70) rotations and spell gems.",
            Default = false,
            RequiresLoadoutChange = true,
        },
        ['DoRain']               = {
