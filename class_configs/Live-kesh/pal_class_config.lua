...
local _ClassConfig = {
    ...
    ['AbilitySets']       = {
        ...
        ['YaulpSpell'] = { -- PAL scribe only (Yaulp V+ is CLR-only); AA fallback is Knight's Yaulp
            "Yaulp IV",     -- Level 60 (PAL)
            "Yaulp III",    -- Level 44 (PAL)
            "Yaulp II",     -- Level 29 (PAL)
            "Yaulp",        -- Level 15 (PAL)
        },
        ['UndeadNuke'] = {
    ...
    ['Rotations']         = {
        ...
        ['Combat'] = {
            ...
            },
            {
                name = "YaulpSpell",
                type = "Spell",
                load_cond = function(self) return not Casting.CanUseAA("Knight's Yaulp") end,
                cond = function(self, spell)
    ...
    ['SpellList']         = {
        {
            ...
            spells = {
                ...
                { name = "YaulpSpell",   cond = function(self) return not Casting.CanUseAA("Knight's Yaulp") end, },
