...
local _ClassConfig = {
    ...
    ['AbilitySets']       = {
        ...
        ['SingleHPBuff'] = {
            -- Single Target HP Buff (Skin Like Wood line)
            "Emberquartz Skin",           -- Level 125
            "Luclinite Skin",             -- Level 120
            "Opaline Skin",               -- Level 115
            "Arcronite Skin",             -- Level 110
            "Shieldstone Skin",           -- Level 105
            "Granitebark Skin",           -- Level 100
            "Stonebark Skin",             -- Level 95
            "Timbercore Skin",            -- Level 90
            "Heartwood Skin",             -- Level 85
            "Ironwood Skin",              -- Level 80
            "Direwild Skin",              -- Level 75
            "Steeloak Skin",              -- Level 70
            "Protection of the Cabbage",  -- Level 65
            "Natureskin",                 -- Level 52
            "Skin like Nature",           -- Level 44
            "Skin like Diamond",          -- Level 39
            "Skin like Steel",            -- Level 29
            "Skin like Rock",             -- Level 19
    ...
    ['Rotations']         = {
        ['DPS'] = {
            {
                name = "SunrayDot",
                type = "Spell",
                load_cond = function() return Config:GetSetting('DoSunrayDot') end,
                cond = function(self, spell)
                    return Config:GetSetting('DoSunrayDot') and Core.IsModeActive("Heal") and Config:GetSetting('DoFire') and Casting.DotSpellCheck(spell) and
                        Config:GetSetting('DoDot') and Casting.ReagentCheck(spell)
                end,
            },
            {
                name = "ChillDot",
            ...
            },
            {
                name = "HordeDot",
                type = "Spell",
                load_cond = function() return Config:GetSetting('DoHordeDot') end,
                cond = function(self, spell)
                    return Config:GetSetting('DoHordeDot') and Casting.DotSpellCheck(spell) and Config:GetSetting('DoDot')
                end,
            },
            {
                name = "DichoSpell",
            ...
            },
            {
                name = "WinterFireDD",
                type = "Spell",
                load_cond = function() return Config:GetSetting('DoWinterFireDD') end,
                cond = function(self, spell)
                    return Config:GetSetting('DoWinterFireDD') and Casting.DetSpellCheck(spell) and Config:GetSetting('DoFire') and Casting.OkayToNuke()
                end,
            },
            {
                name = "IceRainNuke",
        ...
        ['GroupBuff'] = {
            ...
            },
            {
                name = "SingleHPBuff",
                type = "Spell",
                load_cond = function() return Config:GetSetting('DoSingleHPBuff') end,
                active_cond = function(self, spell) return true end,
                cond = function(self, spell, target)
                    if not Config:GetSetting('DoSingleHPBuff') then return false end
                    if Config:GetSetting('SingleHPBuffTarget') == 2 and not Targeting.TargetIsATank(target) then return false end
                    return Casting.GroupBuffCheck(spell, target)
                end,
            },
            {
    ...
    ['Spells']            = {
        ...
        },
        {
            ...
            spells = {
                ...
                },
                {
                    name = "SnareSpell",
                    cond = function(self)
                        return Config:GetSetting('DoSnare') and not Casting.CanUseAA("Entrap")
                    end,
                },
                -- [ HEAL MODE ] --
                ...
                -- [ Fall Back ]--
                { name = "WinterFireDD",   cond = function(self) return Config:GetSetting('DoWinterFireDD') and Config:GetSetting("DoFire") end, },
        ...
        },
        {
            ...
            spells = {
                -- [ MANA MODE ] --
                { name = "WinterFireDD",   cond = function(self) return Config:GetSetting('DoWinterFireDD') and Core.IsModeActive("Mana") end, },
                -- [ HEAL MODE ] --
        ...
        },
        {
            ...
            spells = {
                -- [ MANA MODE ] --
                { name = "HordeDot",      cond = function(self) return Config:GetSetting('DoHordeDot') and Core.IsModeActive("Mana") end, },
                -- [ HEAL MODE ] --
                { name = "LongGroupHeal", cond = function(self) return mq.TLO.Me.Level() >= 70 end, },
                { name = "SunDot",        cond = function(self) return true end, },
                { name = "SunrayDot",     cond = function(self) return Config:GetSetting('DoSunrayDot') end, },
                -- [ Fall Back ]--
                { name = "SunrayDot",     cond = function(self) return Config:GetSetting('DoSunrayDot') end, },
            },
        },
        {
            ...
            spells = {
                ...
                -- [ HEAL MODE ] --
                { name = "SunrayDot",           cond = function(self) return Config:GetSetting('DoSunrayDot') and mq.TLO.Me.Level() >= 73 end, },
        ...
        },
        {
            ...
            spells = {
                ...
                { name = "SingleHPBuff",        cond = function(self) return Config:GetSetting('DoSingleHPBuff') end, },
                { name = "GroupCure",           cond = function(self) return true end, },
                { name = "ReptileCombatInnate", cond = function(self) return true end, },
            },
        },
    ...
    ['DefaultConfig']     = {
        ...
        ['DoSunrayDot']  = {
            DisplayName = "Cast Sunray DoT",
            Group = "Abilities",
            Header = "Damage",
            Category = "Over Time",
            Tooltip = "Use Sunray DoT spells (Heal mode fire DoT line).",
            RequiresLoadoutChange = true,
            Default = true,
        },
        ['DoHordeDot']   = {
            DisplayName = "Cast Horde DoT",
            Group = "Abilities",
            Header = "Damage",
            Category = "Over Time",
            Tooltip = "Use Horde / insect DoT spells (Stinging Swarm line).",
            RequiresLoadoutChange = true,
            Default = true,
        },
        ['DoWinterFireDD'] = {
            DisplayName = "Cast Winter's Flame DD",
            Group = "Abilities",
            Header = "Damage",
            Category = "Direct",
            Tooltip = "Use Winter's Flame direct damage spells (requires Cast Fire Spells).",
            RequiresLoadoutChange = true,
            Default = true,
        },
        ['DoTwinHeal']   = {
        ...
        ['DoSingleHPBuff']     = {
            DisplayName = "Single HP Buff",
            Group = "Abilities",
            Header = "Buffs",
            Category = "Group",
            Tooltip = "Use single-target HP buffs (Skin like Wood line) on group members during downtime.",
            RequiresLoadoutChange = true,
            Default = false,
        },
        ['SingleHPBuffTarget'] = {
            DisplayName = "Single HP Buff Target",
            Group = "Abilities",
            Header = "Buffs",
            Category = "Group",
            Type = "Combo",
            ComboOptions = { 'Everyone', 'Tank Only', },
            Default = 1,
            Min = 1,
            Max = 2,
            Tooltip = "Who to apply Single HP Buffs to.",
        },
        ['DoTempHP']     = {
