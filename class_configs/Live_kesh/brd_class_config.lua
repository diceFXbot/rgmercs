...
local _ClassConfig = {
    ...
    ['SpellList']       = { -- New style spell list, gemless, priority-based. Will use the first set whose conditions are met.
        {
            ...
            spells = {
                ...
                -- regen songs
                { name = "GroupRegenSong", cond = function(self) return true end, },
                { name = "AreaRegenSong",  cond = function(self) return mq.TLO.Me.Level() >= 86 end, },
    ...
    ['RotationOrder']   = {
        ...
        },
        {
            ...
            targetId = function(self) return { mq.TLO.Me.ID(), } end,
            cond = function(self, combat_state)
                return combat_state == "Combat" and Targeting.GetAutoTargetPctHPs() > 0 and Targeting.GetAutoTargetPctHPs() < 20
            end,
        },
    },
    ['Rotations']       = {
        ...
        ['CombatSongs'] = {
            ...
            },
            {
                name = "GroupRegenSong",
                type = "Song",
                load_cond = function(self) return Core.GetResolvedActionMapItem('GroupRegenSong') end,
                cond = function(self, songSpell)
            ...
            },
            {
                name = "AreaRegenSong",
                type = "Song",
                load_cond = function(self) return mq.TLO.Me.Level() >= 86 and Core.GetResolvedActionMapItem('AreaRegenSong') end,
                cond = function(self, songSpell)
                    return self.ClassConfig.HelperFunctions.RefreshBuffSong(songSpell)
                end,
            },
        ...
        ['GroupBuff'] = {
            {
                ...
                cond = function(self, aaName, target)
                    ...
                    return Casting.AddedBuffCheck(717, target)
                end,
            },
        },
        ['SeloPreEnd'] = {
    ...
    ['DefaultConfig']   = {
        ...
        ['UseRegen']        = {
            ...
            Index = 101,
            Tooltip = "When to use regen songs.",
            Type = "Combo",
