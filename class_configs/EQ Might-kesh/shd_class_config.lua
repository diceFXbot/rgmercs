...
local _ClassConfig = {
    ...
    ['RotationOrder'] = {
        ...
        { --Prioritized in their own rotation to help keep HP topped to the desired level, includes emergency abilities
            ...
            targetId = function(self)
                ...
                return targetID > 0 and { targetID, } or {}
            end,
            cond = function(self, combat_state)
                return combat_state == "Combat"
            end,
    ...
    ['Rotations']     = {
        ...
        ['HateTools(AutoTarget)'] = {
            ...
            {
                name = "Trinket of Garudon",
                type = "Item",
                load_cond = function(self) return mq.TLO.FindItem("=Trinket of Garudon")() end,
        ...
        ['Combat'] = {
            ...
            },
            {
                ...
                cond = function(self, spell, target)
                    ...
                    return Casting.HaveManaToDot() and Casting.OkayToDotByCon(target) and Casting.SelfBuffCheck(spell) -- use for recourse --Casting.DotSpellCheck(spell)
                end,
            },
            {
                name = "PoisonDot",
