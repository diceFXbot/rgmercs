...
--- ST mez in progress; WaitCastFinish aborts when MezCastTargetId == AutoTargetID.
Globals.MezInterruptOnMATarget        = false
Globals.MezCastTargetId               = 0
Globals.BackOffFlag                   = false
Globals.InMedState                    = false
Globals.LastAsyncCastFireMs           = 0
Globals.LastAsyncCastEndMs            = 0
...
Globals.Constants.RGMezzedAnims       = Set.new({ 26, 32, 71, 72, 110, 111, })
