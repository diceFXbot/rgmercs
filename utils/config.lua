...
Config.DefaultConfig                                     = {
    ...
    ['ShrinkStages']               = {
        DisplayName = "Shrink Stages",
        Group = "Items",
        Header = "Clickies",
        Category = "General Clickies",
        Index = 7,
        Tooltip = "Choose whether to stop after one shrink cast or allow a second cast.",
        Type = "Combo",
        ComboOptions = { 'One Stage', 'Two Stages', },
        Default = 2,
        Min = 1,
        Max = 2,
        ConfigType = "Normal",
    ...
    ['MovebackWhenBehindMode']     = {
        DisplayName = "Mob Behind Reaction",
        Group = "Combat",
        Header = "Positioning",
        Category = "Tank Positioning",
        Index = 3,
        Tooltip = "How to react when a mob is detected behind you while tanking.",
        Default = 1,
        Min = 1,
        Max = 2,
        Type = "Combo",
        ComboOptions = { 'Moveback', 'Go Behind Current Target + Face Fast', },
        ConfigType = "Advanced",
    },
    ['DoCombatCampCheck']          = {
        DisplayName = "Combat Camp Return",
        Group = "Combat",
        Header = "Positioning",
        Category = "Tank Positioning",
        Index = 4,
        Tooltip = "When tanking with Moveback if Mob Behind enabled, allow in-combat return-to-camp checks.",
        Default = true,
        ConfigType = "Advanced",
    },
    ['MovebackDistance']           = {
    ...
    ['AETauntTriggerCnt']                = {
        DisplayName = "AE Taunt Trigger Count",
        Group = "Abilities",
        Header = "Tanking",
        Category = "Hate Tools",
        Index = 113,
        Tooltip = "When AE Taunt Safety Check is off, minimum number of eligible AE taunt targets before use.",
        Default = 1,
        Min = 1,
        Max = 30,
    },
    ['AETauntAggroThreshold']            = {
        DisplayName = "AE Taunt Aggro Threshold",
        Group = "Abilities",
        Header = "Tanking",
        Category = "Hate Tools",
        Index = 114,
        Tooltip = "Eligible targets must be below this aggro percent to count for AE Taunt checks.",
        Default = 100,
        Min = 1,
        Max = 100,
    },
